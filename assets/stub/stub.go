...
func stubCoreCoreStub() (*asset, error) {
	...
	info := bindataFileInfo{name: "stub/core/core.stub", size: 2495, mode: os.FileMode(420), modTime: time.Unix(1590463989, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
